package com.waiyanoo.moviesadmin.adapters;
...
import com.waiyanoo.moviesadmin.GenresFragment;
import com.waiyanoo.moviesadmin.R;
import com.waiyanoo.moviesadmin.models.Genre;
import com.waiyanoo.moviesadmin.models.Movie;
import com.waiyanoo.moviesadmin.models.Series;
import com.waiyanoo.moviesadmin.ui.GenreFormBottomSheet;
                                                                                ...
                                                                                if (movie.getGenreId().equals(genres.get(position).getId())) {
                                                                                    ...
                                                                                    db.collection(Movie.COLLECTION_NAME)
                                                                                            ...
                                                                                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                                                                @Override
                                                                                                public void onSuccess(Void aVoid) {
                                                                                                    Toast.makeText(genresFragment.getContext(), "Genre Delete Success!", Toast.LENGTH_SHORT).show();
